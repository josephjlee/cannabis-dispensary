...
if(
	...
	if( empty($_POST['contact-fname']) && empty($_POST['contact-lname']) && empty($_POST['contact-email']) && empty($_POST['contact-message']) ) {
	...
	if (!filter_var($_POST['contact-email'], FILTER_VALIDATE_EMAIL) === false) {
		...
		$msg = "Name: ".$_POST['contact-fname']."\r\n";		
		$msg = "Name: ".$_POST['contact-lname']."\r\n";		
		$msg .= "Email: ".$_POST['contact-email']."\r\n";
		$msg .= "Message: ".$_POST['contact-message']."\r\n";
		
		$success = @mail($mailTo, $_POST['contact-email'], $msg, 'From: ' . $_POST['contact-fname'] . '<' . $_POST['contact-email'] . '>');
